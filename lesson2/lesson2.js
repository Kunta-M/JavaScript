...
for (const simpson of simpsons) {
    document.write(`<div>${simpson.name} - ${simpson.surname} - ${simpson.age} - ${simpson.info}</div> - <img src="${simpson.photo}" alt="">`)
}
document.write('</div>')



document.write('<div class="simpson_style">')
for (const simpson of simpsons) {
    document.write(`<div>
...
/*3. Використовуючи данні з масиву, за допомоги document.write та циклу
            побудувати структуру по шаблону template3.1
...
document.write('<div class="product_style">')

for (let product of products){
    document.write(`<div>
        <h3>${product.title}. Price - ${product.price} UAH</h3>
        <img src="${product.image}" alt="Products photo">
    </div>`)
}
document.write('</div>')
